...
const DEVICE_LABEL_KEYS: Record<DeviceLabelKey, string> = {
  ...
  candidateRevoke: "device.candidateRevoke",
  candidateClaimed: "device.candidateClaimed",
  adoptionTitle: "device.adoptionTitle",
  adoptionNote: "device.adoptionNote",
  adoptionSave: "device.adoptionSave",
  adoptionNone: "device.adoptionNone",
  adoptionPlaceholder: "device.adoptionPlaceholder",
  createTitle: "device.createTitle",
  createNote: "device.createNote",
  createImei: "device.createImei",
  createFamily: "device.createFamily",
  createSubmit: "device.createSubmit",
  createUngated: "device.createUngated",
  ...
  reconfirm_modem: "device.reconfirm_modem",
  update_modem: "cmd.update_modem",
  create_modem: "cmd.create_modem",
